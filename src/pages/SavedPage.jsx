  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div className="page-header">
        <div className="page-title">Your Gems</div>
      ...
      {savedSongs.length === 0 ? (
        <div className="empty-state" style={{ flex: 1 }}>
          ...
          <div className="empty-sub">Swipe right on songs in Discover to save them here</div>
        </div>
      ) : (
        <div style={{ flex: 1, overflowY: 'auto' }}>
          <div className="saved-grid">
            {savedSongs.map((song) => {
              ...
              return (
                <div key={song.id} className="saved-item" onClick={() => openArtist(song)}>
                  <div className="saved-item-bg" style={{ backgroundImage: `url(${song.coverArt})` }} />
